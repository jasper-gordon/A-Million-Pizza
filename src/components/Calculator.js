...
export const Calculator = () => {
  ...
  const calculateRecipe = () => {
    ...
    console.log("Type of water: " + typeof values.water);
    let totalWeight = values.size * values.pizzas;
    console.log("Weight" + totalWeight);
    const flourW = totalWeight / totalPercent;
    console.log("Flour" + flourW);
    flour = totalWeight / totalPercent;
    water = flour * values.water;
    salt = flour * values.salt;
    yeast = flour * values.yeast;
    oil = flour * values.oil;
  ...
  const handleChange = (prop) => (event) => {
    ...
    if (event.target.value != "") {
      ...
      //BUG: Causes error if non num so dealing with empty stirng but other issues remain
      //Couple this solution with understnading of error validation for text field
    } else {
    ...
    <>
      ...
      >
        ...
        <Button
          onClick={() => {
            calculateRecipe();
            console.log("This is flour weight: " + flour);
